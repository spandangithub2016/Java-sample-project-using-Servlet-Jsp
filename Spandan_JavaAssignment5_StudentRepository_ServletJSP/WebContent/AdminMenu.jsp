    ...
    <br><br><br><br>   
        ...
        <div id="set">
            ...
            <br>
                ...
                <a href="Registration.jsp" class="button button2">Add Student</a>                
                <a href="Delete.jsp" class="button button2">Delete Student</a>
                <br>
                <a href="Login.jsp" class="button button2">Log Out</a>
